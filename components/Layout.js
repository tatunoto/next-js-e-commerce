      ...
      <main className="my-8">{children}</main>
       <footer className="bg-gray-100 text-md font-medium text-gray-500">
        <div className="container mx-auto px-6 py-3 flex justify-between items-center">
         <span className="mt-3 sm:flex sm:justify-center sm:items-center text-md text-gray-700">Powered by <a href="https://www.delirium.design" className="hover:text-purple-400">Delirium Design</a> - 2021, all rights reserved</span>
        </div>
      </footer>
    </div>
  );
